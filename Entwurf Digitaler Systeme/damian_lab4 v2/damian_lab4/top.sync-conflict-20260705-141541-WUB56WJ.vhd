...
data_width => 16 -- 512 werte, : integer := 11
    ...
    einstellwert_input => einstellwert_internal,
...
process(keys, einstellwert_input)
begin
    if keys = (others => '0') then
        einstellwert_internal <= einstellwert_input; -- allow external override when no key pressed
    elsif keys(3) = '1' then
        ...
        einstellwert_internal <= einstellwert_input;
    end if;
end process;
...
aud_daclrck => lr_clk, -- : out std_logic; -- Links / Rechts
