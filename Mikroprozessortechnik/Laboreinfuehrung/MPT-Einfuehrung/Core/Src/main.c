...
{
	int integer = 3;
	float floatzahl = 2.75;
	float ergebnis;
	ergebnis = integer * floatzahl;
	(void)ergebnis;
	__asm__("nop;");
}
// */
...
float ergebnis_integer, ergebnis_float;

ergebnis_integer = integer_1 / integer_2;
ergebnis_float = integer_1 / floatzahl;
(void)ergebnis_integer;
(void)ergebnis_float;
__asm__("nop;");
}
*/
